    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">All Article</div>
        </div>
      </div>
                ...
                <div class="table-responsive">
                    <table id="table_id" class="display">
                        ...
                        <tr>
                          ...
                          <td>{{ $post->action }}
                            <div>
                              <a class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="" href="{{ route('post.edit',$post->id) }}" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
